...
const ListedTamagotchi = ({id, name, fome, sono, diversao}: TamagotchiProps) => {
    return (
        <TouchableOpacity onPress={() => router.push({pathname: '/Tamagotchi', params: {id, name, fome, sono, diversao}})}>
